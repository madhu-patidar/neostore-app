...
const addAddress= (req:Request,res:Response)=>{
   ...
   Joi.validate({u_id:id,u_address:req.body.address,u_pincode:req.body.pincode,u_city:req.body.city,u_state:req.body.state,u_country:req.body.country},schema,(err,result)=>{
    if(err){
