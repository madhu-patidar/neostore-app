...
var sortByDescending = function (req, res) {
    ...
    if (id == customer_id) {
        product_list_1.default.aggregate([
            ...
            if (err)
                ...
                res.status(200).json({ success: true, message: 'Products in Descending order', products: result });
            }
        });
    }
    else {
...
exports.default = sortByDescending;
